...
def argparser():
    ...
    parser.add_argument("--encoder_layer_norm", action='store_true', default=True)
    parser.add_argument("--mp_layer_norm", action='store_true', default=True)
...
if __name__ == "__main__":
    ...
    # if listt["dataset"]=="advection":
    #     from neuralif.geo_advection import main, device
    # else:
    #     from neuralif.geo import main, device
